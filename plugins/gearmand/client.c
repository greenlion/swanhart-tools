...
/*
 * Functions for q_servers_set.
 */

my_bool q_servers_set_init(UDF_INIT *initid, UDF_ARGS *args, char *message);
void q_servers_set_deinit(UDF_INIT *initid);
char *q_servers_set(UDF_INIT *initid, UDF_ARGS *args, char *result,
...
my_bool q_do_init(UDF_INIT *initid, UDF_ARGS *args, char *message);
void q_do_deinit(UDF_INIT *initid);
char *q_do(UDF_INIT *initid, UDF_ARGS *args, char *result,
              unsigned long *length, char *is_null, char *error);
...
/*
 * Functions for q_do_high.
 */

my_bool q_do_high_init(UDF_INIT *initid, UDF_ARGS *args, char *message);
void q_do_high_deinit(UDF_INIT *initid);
char *q_do_high(UDF_INIT *initid, UDF_ARGS *args, char *result,
                   unsigned long *length, char *is_null, char *error);
...
/*
 * Functions for q_do_low.
 */

my_bool q_do_low_init(UDF_INIT *initid, UDF_ARGS *args, char *message);
void q_do_low_deinit(UDF_INIT *initid);
char *q_do_low(UDF_INIT *initid, UDF_ARGS *args, char *result,
                   unsigned long *length, char *is_null, char *error);
...
/*
 * Functions for q_do_background.
 */

my_bool q_do_background_init(UDF_INIT *initid, UDF_ARGS *args,
                                char *message);
void q_do_background_deinit(UDF_INIT *initid);
char *q_do_background(UDF_INIT *initid, UDF_ARGS *args, char *result,
                         unsigned long *length, char *is_null, char *error);
...
/*
 * Functions for q_do_high_background.
 */

my_bool q_do_high_background_init(UDF_INIT *initid, UDF_ARGS *args,
                                char *message);
void q_do_high_background_deinit(UDF_INIT *initid);
char *q_do_high_background(UDF_INIT *initid, UDF_ARGS *args, char *result,
                         unsigned long *length, char *is_null, char *error);
...
/*
 * Functions for q_do_low_background.
 */

my_bool q_do_low_background_init(UDF_INIT *initid, UDF_ARGS *args,
                                char *message);
void q_do_low_background_deinit(UDF_INIT *initid);
char *q_do_low_background(UDF_INIT *initid, UDF_ARGS *args, char *result,
                         unsigned long *length, char *is_null, char *error);
...
my_bool q_sum_init(UDF_INIT *initid, UDF_ARGS *args, char *message);
void q_sum_deinit(UDF_INIT *initid);
long long q_sum(UDF_INIT *initid, UDF_ARGS *args, char *is_null,
                   char *error);
void q_sum_reset(UDF_INIT *initid, UDF_ARGS *args, char *is_null,
                    char *error);
void q_sum_clear(UDF_INIT *initid, char *is_null, char *error);
void q_sum_add(UDF_INIT *initid, UDF_ARGS *args, char *is_null, char *error);
                    ...
                    char *error)
{
  ...
  q_sum_clear(initid, is_null, error);
  q_sum_add(initid, args, is_null, error);
}
