...
if($argc > 1) {
  ...
  $sq_username = empty($ini['user']) ? $default['user'] : $ini['user'];
  $sq_password = empty($ini['password']) ? $default['password'] : $ini['password'];

  $username = $ini['root_user'];
  $password = $ini['root_password'];
  $drop_user = "y";
